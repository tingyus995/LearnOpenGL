...
int main() {
	...
	Shader lightingShader("src/lightingShader.vs", "src/lightingShader.fs");
	Shader lightCubeShader("src/lightSourceshader.vs", "src/lightSourceshader.fs");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		for (int i = 0; i < 4; ++i) {
			lightingShader.setVec3f("pointLights[" + std::to_string(i) + "].position", pointLightPositions[i]);
			...
			lightingShader.setVec3f("pointLights[" + std::to_string(i) + "].ambient", 0.2f, 0.2f, 0.2f);
			lightingShader.setVec3f("pointLights[" + std::to_string(i) + "].diffuse", 0.8f, 0.8f, 0.8f);
			lightingShader.setVec3f("pointLights[" + std::to_string(i) + "].specular", 1.0f, 1.0f, 1.0f);
		}
